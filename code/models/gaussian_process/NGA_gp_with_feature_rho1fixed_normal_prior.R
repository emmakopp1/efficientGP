# Rscript NGA_gp_with_feature_rho1fixed_normal_prior.R > ../../../output/logs/NGA_gp_with_feature_rho1fixed_normal_prior_$(date +%Y%m%d_%H%M%S).log 2>&1 &
