"""
SHAP analysis for FCS prediction — Chad
...
def run_shap_analysis(features_scaled, target):
    print("=" * 60)
    print("  CHAD — SHAP Analysis")
    print("=" * 60)
    ...
    ax.set_title("Chad — Top 15 Mean SHAP Importance", fontsize=14)
    ax.invert_yaxis()
    fig.tight_layout()
    out_path = dir_figures / "chad_mean_shap_importance.png"
...
if __name__ == "__main__":
    ...
    run_shap_analysis(features_tcd, target_tcd)
